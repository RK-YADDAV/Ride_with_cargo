...
import {
  ...
  List_default,
  Paper_default
} from "./chunk-FY2PZYBG.js";
import {
  Typography_default
} from "./chunk-G7ZEZWTN.js";
import {
  init_utils
} from "./chunk-KXJ45PPI.js";
import {
  createSvgIcon
} from "./chunk-TE3AZMIL.js";
import {
  useThemeProps
} from "./chunk-HSACN6VJ.js";
import {
  useTheme
} from "./chunk-GIDMCM6G.js";
import {
  Button_default
} from "./chunk-UYEICTAI.js";
import {
  ButtonBase_default
} from "./chunk-HVN6VTYR.js";
import {
  CSSTransition_default,
  TransitionGroup_default
} from "./chunk-DT3RLZSX.js";
import {
  alpha,
  useMediaQuery,
  useRtl
} from "./chunk-O2HZW6SI.js";
import {
  init_esm,
  init_useControlled,
...
var PickersLayout = React6.forwardRef(function PickersLayout2(inProps, ref) {
  ...
  return (0, import_jsx_runtime4.jsxs)(PickersLayoutRoot, {
    ...
    children: [isLandscape ? shortcuts : toolbar, isLandscape ? toolbar : shortcuts, (0, import_jsx_runtime4.jsx)(PickersLayoutContentWrapper, {
      ...
      children: wrapperVariant === "desktop" ? (0, import_jsx_runtime4.jsxs)(React6.Fragment, {
        children: [content, tabs]
      }) : (0, import_jsx_runtime4.jsxs)(React6.Fragment, {
...
var ClockIcon = createSvgIcon((0, import_jsx_runtime5.jsxs)(React7.Fragment, {
...
var TimeIcon = createSvgIcon((0, import_jsx_runtime5.jsxs)(React7.Fragment, {
  children: [(0, import_jsx_runtime5.jsx)("path", {
    d: "M11.99 2C6.47 2 2 6.48 2 12s4.47 10 9.99 10C17.52 22 22 17.52 22 12S17.52 2 11.99 2zM12 20c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8z"
  }), (0, import_jsx_runtime5.jsx)("path", {
    d: "M12.5 7H11v6l5.25 3.15.75-1.23-4.5-2.67z"
...
var useClearableField = (props) => {
  ...
  return _extends({}, other, {
    InputProps: _extends({}, InputProps, {
      endAdornment: (0, import_jsx_runtime6.jsxs)(React8.Fragment, {
        children: [clearable && (0, import_jsx_runtime6.jsx)(InputAdornment_default, {
          position: "end",
          sx: {
            marginRight: (InputProps == null ? void 0 : InputProps.endAdornment) ? -1 : -1.5
          },
          children: (0, import_jsx_runtime6.jsx)(IconButton, _extends({}, iconButtonProps, {
            onClick: onClear,
            children: (0, import_jsx_runtime6.jsx)(EndClearIcon, _extends({
              fontSize: "small"
            }, endClearIconProps))
          }))
...
var PickersContext = React11.createContext(null);
...
var usePickersContext = () => {
  const value = React12.useContext(PickersContext);
  if (value == null) {
...
var PickersDayRaw = React13.forwardRef(function PickersDay(inProps, forwardedRef) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiPickersDay"
  });
...
var PickersDay2 = React13.memo(PickersDayRaw);
...
var PickersMonth = React14.memo(function PickersMonth2(inProps) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiPickersMonth"
  });
  ...
  return (0, import_jsx_runtime9.jsx)(PickersMonthRoot, _extends({
    className: clsx_default(classes.root, className),
    ownerState: props
  }, other, {
    children: (0, import_jsx_runtime9.jsx)(MonthButton, _extends({}, monthButtonProps))
  }));
});
...
var MonthCalendar = React16.forwardRef(function MonthCalendar2(inProps, ref) {
  ...
  const todayMonth = React16.useMemo(() => utils.getMonth(now), [utils, now]);
  const selectedMonth = React16.useMemo(() => {
    if (value != null) {
      return utils.getMonth(value);
    }
    return null;
  }, [value, utils]);
  const [focusedMonth, setFocusedMonth] = React16.useState(() => selectedMonth || utils.getMonth(referenceDate));
  ...
  const isMonthDisabled = React16.useCallback((dateToValidate) => {
  ...
  return (0, import_jsx_runtime10.jsx)(MonthCalendarRoot, _extends({
    ref,
    className: clsx_default(classes.root, className),
    ownerState,
    role: "radiogroup",
    ...
    children: getMonthsInYear(utils, value ?? referenceDate).map((month) => {
      ...
      return (0, import_jsx_runtime10.jsx)(PickersMonth, {
        selected: isSelected,
        value: monthNumber,
...
var PickersYear = React17.memo(function PickersYear2(inProps) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiPickersYear"
  });
  ...
  return (0, import_jsx_runtime11.jsx)(PickersYearRoot, _extends({
    className: clsx_default(classes.root, className),
    ownerState: props
  }, other, {
    children: (0, import_jsx_runtime11.jsx)(YearButton, _extends({}, yearButtonProps))
  }));
});
...
var YearCalendar = React18.forwardRef(function YearCalendar2(inProps, ref) {
  ...
  const todayYear = React18.useMemo(() => utils.getYear(now), [utils, now]);
  const selectedYear = React18.useMemo(() => {
    if (value != null) {
      return utils.getYear(value);
    }
    return null;
  }, [value, utils]);
  const [focusedYear, setFocusedYear] = React18.useState(() => selectedYear || utils.getYear(referenceDate));
  const [internalHasFocus, setInternalHasFocus] = useControlled({
    name: "YearCalendar",
    state: "hasFocus",
    controlled: hasFocus,
  ...
  return (0, import_jsx_runtime12.jsx)(YearCalendarRoot, _extends({
    ref: handleRef,
    className: clsx_default(classes.root, className),
    ownerState,
    role: "radiogroup",
    ...
    children: yearRange.map((year) => {
      ...
      return (0, import_jsx_runtime12.jsx)(PickersYear, {
        selected: isSelected,
        value: yearNumber,
...
function PickersSlideTransition(inProps) {
  ...
  return (0, import_jsx_runtime16.jsx)(PickersSlideTransitionRoot, {
    className: clsx_default(classes.root, className),
    childFactory: (element) => React25.cloneElement(element, {
      classNames: transitionClasses
    }),
    role: "presentation",
    children: (0, import_jsx_runtime16.jsx)(CSSTransition_default, _extends({
      mountOnEnter: true,
      unmountOnExit: true,
...
function WrappedDay(_ref) {
  ...
  const isDisabled = React26.useMemo(() => disabled || isDateDisabled(day), [disabled, isDateDisabled, day]);
  const outsideCurrentMonth = React26.useMemo(() => utils.getMonth(day) !== currentMonthNumber, [utils, day, currentMonthNumber]);
  const isFirstVisibleCell = React26.useMemo(() => {
  ...
  const isLastVisibleCell = React26.useMemo(() => {
  ...
  return (0, import_jsx_runtime17.jsx)(Day, _extends({}, dayProps, {
    day,
    disabled: isDisabled,
...
function DayCalendar(inProps) {
  ...
  const validSelectedDays = React26.useMemo(() => selectedDays.filter((day) => !!day).map((day) => utils.startOfDay(day)), [utils, selectedDays]);
  ...
  const weeksToDisplay = React26.useMemo(() => {
  ...
  return (0, import_jsx_runtime17.jsxs)(PickersCalendarDayRoot, {
    role: "grid",
    "aria-labelledby": gridLabelId,
    ...
    children: [(0, import_jsx_runtime17.jsxs)(PickersCalendarDayHeader, {
      ...
      children: [displayWeekNumber && (0, import_jsx_runtime17.jsx)(PickersCalendarWeekNumberLabel, {
        variant: "caption",
        role: "columnheader",
        "aria-label": translations.calendarWeekNumberHeaderLabel,
        className: classes.weekNumberLabel,
        children: translations.calendarWeekNumberHeaderText
      }), getWeekdays(utils, now).map((weekday, i) => (0, import_jsx_runtime17.jsx)(PickersCalendarWeekDayLabel, {
        variant: "caption",
        role: "columnheader",
    ...
    }), loading ? (0, import_jsx_runtime17.jsx)(PickersCalendarLoadingContainer, {
      className: classes.loadingContainer,
      children: renderLoading()
    }) : (0, import_jsx_runtime17.jsx)(PickersCalendarSlideTransition, _extends({
      ...
      children: (0, import_jsx_runtime17.jsx)(PickersCalendarWeekContainer, {
        ref: slideNodeRef,
        role: "rowgroup",
        ...
        children: weeksToDisplay.map((week, index) => (0, import_jsx_runtime17.jsxs)(PickersCalendarWeek, {
          ...
          children: [displayWeekNumber && (0, import_jsx_runtime17.jsx)(PickersCalendarWeekNumber, {
            className: classes.weekNumber,
            role: "rowheader",
            "aria-label": translations.calendarWeekNumberAriaLabelText(utils.getWeekNumber(week[0])),
            children: translations.calendarWeekNumberText(utils.getWeekNumber(week[0]))
          }), week.map((day, dayIndex) => (0, import_jsx_runtime17.jsx)(WrappedDay, {
            parentProps: props,
            day,
...
var PickersPopperPaperWrapper = React31.forwardRef((props, ref) => {
  const {
    PaperComponent,
    popperPlacement,
  ...
  return (0, import_jsx_runtime21.jsx)(PaperComponent, _extends({}, other, paperProps, {
    onClick: (event) => {
      var _a;
      onPaperClick(event);
...
function PickersPopper(inProps) {
  ...
  return (0, import_jsx_runtime21.jsx)(Popper, _extends({}, popperProps, {
    children: ({
      TransitionProps,
      placement: popperPlacement
    }) => (0, import_jsx_runtime21.jsx)(FocusTrap, _extends({
      open,
      ...
      children: (0, import_jsx_runtime21.jsx)(Transition, _extends({}, TransitionProps, slotProps == null ? void 0 : slotProps.desktopTransition, {
        children: (0, import_jsx_runtime21.jsx)(PickersPopperPaperWrapper, {
...
var useOpenState = ({
  ...
  const isControllingOpenProp = React32.useRef(typeof open === "boolean").current;
  const [openState, setIsOpenState] = React32.useState(false);
  React32.useEffect(() => {
  ...
  const setIsOpen = React32.useCallback((newIsOpen) => {
    if (!isControllingOpenProp) {
...
var usePickerValue = ({
  ...
  } = React33.useRef(inDefaultValue);
  const {
    current: isControlled
  } = React33.useRef(inValueWithoutRenderTimezone !== void 0);
  const [previousTimezoneProp, setPreviousTimezoneProp] = React33.useState(timezoneProp);
  if (true) {
    React33.useEffect(() => {
  ...
  const [dateState, setDateState] = React33.useState(() => {
    let initialValue;
  ...
  const viewValue = React33.useMemo(() => valueManager.cleanValue(utils, dateState.draft), [utils, valueManager, dateState.draft]);
  const viewResponse = {
    value: viewValue,
...
var useDesktopPicker = (_ref) => {
  ...
  const _useSlotProps = useSlotProps_default({
    ...
    ownerState: props
  }), inputAdornmentProps = _objectWithoutPropertiesLoose(_useSlotProps, _excluded27);
...
var useFieldState = (params) => {
  ...
  const sectionsValueBoundaries = React38.useMemo(() => getSectionsBoundaries(utils, localizedDigits, timezone), [utils, localizedDigits, timezone]);
  const getSectionsFromValue = React38.useCallback((value, fallbackSections = null) => fieldValueManager.getSectionsFromValue(utils, value, fallbackSections, (date) => buildSectionsFromFormat({
    utils,
    localeText: translations,
    localizedDigits,
    format,
...
var useFieldCharacterEditing = ({
  ...
  const utils = useUtils();
  const [query, setQuery] = React39.useState(null);
...
var useFieldV7TextField = (params) => {
  ...
  const sectionListRef = React40.useRef(null);
  const handleSectionListRef = useForkRef(inSectionListRef, sectionListRef);
  const translations = usePickersTranslations();
  const utils = useUtils();
  const id = useId();
  const [focused, setFocused] = React40.useState(false);
  const interactions = React40.useMemo(() => ({
    syncSelectionToDOM: () => {
  ...
  const sectionBoundaries = React40.useMemo(() => {
    ...
    return state.sections.map((section, index) => {
      ...
      return {
        ...
        content: {
          ...
          [parseInt(React40.version, 10) >= 17 ? "enterKeyHint" : "enterkeyhint"]: isEditable ? "next" : void 0,
...
var useFieldV6TextField = (params) => {
  const isRtl = useRtl();
  const focusTimeoutRef = React41.useRef(void 0);
  const selectionSyncTimeoutRef = React41.useRef(void 0);
  const {
    forwardedProps: {
      onFocus,
      onClick,
  ...
  const sections = React41.useMemo(() => addPositionPropertiesToSections(state.sections, localizedDigits, isRtl), [state.sections, localizedDigits, isRtl]);
  ...
  const placeholder = React41.useMemo(() => {
    if (inPlaceholder !== void 0) {
      return inPlaceholder;
    }
    return fieldValueManager.getV6InputValueFromSections(getSectionsFromValue(valueManager.emptyValue), localizedDigits, isRtl);
  }, [inPlaceholder, fieldValueManager, getSectionsFromValue, valueManager.emptyValue, localizedDigits, isRtl]);
  const valueStr = React41.useMemo(() => state.tempValueStrAndroid ?? fieldValueManager.getV6InputValueFromSections(state.sections, localizedDigits, isRtl), [state.sections, fieldValueManager, state.tempValueStrAndroid, localizedDigits, isRtl]);
  React41.useEffect(() => {
  ...
  const inputMode = React41.useMemo(() => {
    if (activeSectionIndex == null) {
      return "text";
    }
...
var useField = (params) => {
  ...
  const inputError = React42.useMemo(() => {
    if (error !== void 0) {
      return error;
    }
...
var useMobilePicker = (_ref) => {
  ...
  const handleFieldRef = useForkRef(fieldRef, fieldProps.unstableFieldRef);
  const renderPicker = () => (0, import_jsx_runtime24.jsxs)(PickersProvider, {
    contextValue,
    localeText,
...
//# sourceMappingURL=chunk-WD2AMQ32.js.map
